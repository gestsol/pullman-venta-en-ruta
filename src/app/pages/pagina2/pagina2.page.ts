...
export class Pagina2Page implements OnInit {
  ...
  Imprimir2(myItem: any) {
    ...
    this.contenido = `<div style="display: table;">
      ...
      src="data:image/png;base64,"></div>
    <div style="display: table-row;text-align:center">www.pullmanbus.cl</div>
    <br><div style="display: table-row;text-align:center"><small>Caratula: <strong>${this.mys.nCaratula}</strong></small></div>
    <br><div style="display: table-row;text-align:center"><small>RUT: <strong>13.969.123-5</strong></small></div>
    <br><div style="display: table-row;text-align:center"><small>Pos: <strong>4</strong></small></div>
    <br><div style="display: table-row;text-align:center"><small>Fecha:<strong> 08/05/2020</strong></small></div>
    <br><div style="display: table-row;text-align:center"><small>Hora: <strong> 10:00:00</strong></small></div>
